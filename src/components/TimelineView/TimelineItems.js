export const TimelineItems = [
    ...
    },
    {
        ...
        isExpanded: true,
        descriptionItems: [
            'Followed the Software Development Process model to create and maintain multiple apps improving workflow efficiency by 80%.',
            ...
            'Total Downloads from all apps: <b class="confetti-items">11,000+</b>',
        ],
    },
    {
